...
const filePath = path.join(__dirname, '../frontend/src/pages/BookGuidePage.jsx');
let content = fs.readFileSync(filePath, 'utf8');

// 1. Add info grid to OTP screen
...
if (content.includes(otpTarget)) {
  ...
  console.log('OTP section NOT FOUND');
}

// 2. Add info grid to Ongoing screen
...
if (content.includes(ongoingTarget)) {
    ...
    console.log('Ongoing section NOT FOUND');
}
