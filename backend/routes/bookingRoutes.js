...
const { createBooking, getUserBookings, getGuideBookings, updateBookingStatus, acceptBooking, verifyOtp, endBooking, addBookingReview, getBookingById } = require('../controllers/bookingController');
