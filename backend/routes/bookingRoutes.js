...
const { createBooking, getUserBookings, getGuideBookings, updateBookingStatus, acceptBooking, verifyOtp, endBooking, addBookingReview, getBookingById, getNearbyBookings } = require('../controllers/bookingController');
...
router.get('/nearby', authenticateUser, authorizeRole('guide'), getNearbyBookings);
